...
urlpatterns = [
    ...
    url(r'^customer/(?P<pk>[0-9]+)/$', customer_view.CustomerDetail.as_view()),
    url(r'^customers/(?P<pk>[0-9]+)/chains/$', customer_view.CustomerChainView.as_view()),
    url(r'^chains/$', chain_view.ChainList.as_view()),
    url(r'^chain/(?P<pk>[0-9]+)/$', chain_view.ChainDetail.as_view()),
    url(r'^chain/(?P<pk>[0-9]+)/coupons/$', coupon_view.CouponList.as_view()),
    url(r'^chain/(?P<pk_chain>[0-9]+)/coupons/$(?P<pk_coupon>[0-9]+)/', coupon_view.CouponDetail.as_view()),
]